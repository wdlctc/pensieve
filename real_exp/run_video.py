...
#          |
#          v
url = 'http://20.38.34.206/' + 'myindex_' + abr_algo + '.html'
...
try:
	...
	if abr_algo == 'RL':
		command = 'exec /usr/bin/python2 ../rl_server/rl_server_no_training.py ' + exp_id
	elif abr_algo == 'fastMPC':
		command = 'exec /usr/bin/python2 ../rl_server/mpc_server.py ' + exp_id
	elif abr_algo == 'robustMPC':
		command = 'exec /usr/bin/python2 ../rl_server/robust_mpc_server.py ' + exp_id
	else:
		command = 'exec /usr/bin/python2 ../rl_server/simple_server.py ' + abr_algo + ' ' + exp_id
